...
class GuidanceLoss(nn.Module):
    def __init__(self):
        ...
        self.vel_dir_weight = 0  # disabled
    ...
    def forward(self, Df, Dp, goal):
        ...
        GuidanceLoss: similarity_loss (for faster flight in large scenario).
        """
        cur_pos = Df[:, :, 0]
        end_pos = Dp[:, :, 0]
        end_vel = Dp[:, :, 1]
    ...
    def _distance_loss(self, traj_dir, goal_dir):
        """
        Returns:
    ...
    def _similarity_loss(self, traj_dir, goal_dir):
        """
        Returns:
        ...
        Adjust perp_weight to penalize deviation perpendicular to the goal; equals the _distance_loss() when perp_weight = 1.
        """
    ...
    def _derivative_similarity_loss(self, derivative, goal_dir):
        """
